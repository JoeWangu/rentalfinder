...
//    const val USERS_URL = "users/"
    ...
    const val RENTAL_COUNTRY_URL = "rentals/api/country/"
    const val RENTAL_CITY_URL = "rentals/api/city/"
    const val RENTAL_STATE_URL = "rentals/api/state/"
    const val RENTAL_NEIGHBORHOOD_URL = "rentals/api/neighborhood/"
