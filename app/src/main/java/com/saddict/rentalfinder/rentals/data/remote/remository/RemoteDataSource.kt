...
interface RemoteDataSource {
    ...
    suspend fun getSingleRental(id: Int): GetRental
    suspend fun postRental(body: CreateRental): Response<GetRental>
    suspend fun updateRental(id: Int, body: CreateRental): Response<GetRental>
}